...
images_dir = r"C:\Users\jaya1\Desktop\New\eSignify\Our_Dataset\Testing"
# print("Hey")
...
print("You may check the Result folder in the same directory to see the cropped OCR_Results.")